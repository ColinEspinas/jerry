...
impl AdeApp {
    ...
    pub(in crate::code_surface) fn request_hover(
        ...
        let Ok(uri) = jerry_lsp::LspClient::uri_for_path(&absolute_path) else {
            self.dismiss_hover();
            self.dismiss_completions();
            cx.notify();
            return;
        ...
        let task = cx.spawn(async move |this, cx| {
            let params = jerry_lsp::lsp_types::HoverParams {
                ...
                work_done_progress_params: jerry_lsp::lsp_types::WorkDoneProgressParams::default(),
            };
            let result = cx
                .background_executor()
                .spawn(async move {
                    client.request::<jerry_lsp::lsp_types::request::HoverRequest>(
                        params,
                        LSP_QUERY_TIMEOUT,
                    )
                })
    ...
    fn goto_definition_target(&self) -> Option<(PathBuf, jerry_lsp::lsp_types::Position)> {
    ...
    pub(in crate::code_surface) fn trigger_goto_definition(&mut self, cx: &mut Context<Self>) {
        ...
        let Ok(uri) = jerry_lsp::LspClient::uri_for_path(&path) else {
            return;
        };

        let task = cx.spawn(async move |this, cx| {
            let params = jerry_lsp::lsp_types::GotoDefinitionParams {
                text_document_position_params: jerry_lsp::lsp_types::TextDocumentPositionParams {
                    text_document: jerry_lsp::lsp_types::TextDocumentIdentifier { uri },
                    position,
                },
            ...
            let result = cx
                .background_executor()
                .spawn(async move {
                    client.request::<jerry_lsp::lsp_types::request::GotoDefinition>(
                        params,
                        LSP_QUERY_TIMEOUT,
                    )
                })
            ...
            let Ok(target_path) = jerry_lsp::LspClient::path_for_uri(&target_uri) else {
...
mod lsp_hover_wiring_tests {
    ...
    /// `jerry_lsp::client::tests::rust_analyzer_returns_a_real_hover_for_a_documented_function`'s
    ...
    const CALL_SITE_POSITION: jerry_lsp::lsp_types::Position = jerry_lsp::lsp_types::Position {
        line: 8,
        character: 20,
    };
...
mod vue_two_server_wiring_tests {
    ...
    const SCRIPT_POSITION: jerry_lsp::lsp_types::Position = jerry_lsp::lsp_types::Position {
        line: 1,
        character: 7,
    };
    ...
    const REFERENCE_POSITION: jerry_lsp::lsp_types::Position = jerry_lsp::lsp_types::Position {
        line: 3,
        character: 17,
    };
    ...
    const MEMBER_ACCESS_POSITION: jerry_lsp::lsp_types::Position = jerry_lsp::lsp_types::Position {
        line: 3,
        character: 21,
    };
    ...
    fn a_real_vue_file_gets_real_diagnostics_from_both_servers_and_a_real_hover(
        ...
        let uri = jerry_lsp::LspClient::uri_for_path(&app_vue).expect("a real file:// uri");
            ...
            || {
                let params = jerry_lsp::lsp_types::GotoDefinitionParams {
                    text_document_position_params:
                        jerry_lsp::lsp_types::TextDocumentPositionParams {
                ...
                match connection
                    ...
                    .flatten()
                {
                    Some(jerry_lsp::lsp_types::GotoDefinitionResponse::Array(locations))
        ...
        let completions = retry_until_some(
            ...
            || {
                ...
                let items = match connection
                    .request::<jerry_lsp::lsp_types::request::Completion>(params, LSP_QUERY_TIMEOUT)
                    .ok()
                    .flatten()
                {
                    Some(jerry_lsp::lsp_types::CompletionResponse::Array(items)) => items,
                    Some(jerry_lsp::lsp_types::CompletionResponse::List(list)) => list.items,
                    None => Vec::new(),
                };
...
mod diagnostic_popover_tests {
    ...
    fn the_real_diagnostic_card_floats_over_the_code_without_reflowing_it(cx: &mut TestAppContext) {
        ...
        let uri = jerry_lsp::LspClient::uri_for_path(&file_path).expect("a real file:// uri");
        publish_and_wait(
            &client,
            &uri.to_string(),
    ...
    fn open_with_real_diagnostic<'a>(
        ...
        let uri = jerry_lsp::LspClient::uri_for_path(&file_path)
