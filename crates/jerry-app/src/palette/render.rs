...
/// Every changed file's [`FileDiffMark`], keyed by the repo-relative path `jerry_git::diff` reports
...
pub(crate) fn file_diff_marks(diff: Option<&jerry_git::diff::WorktreeDiff>) -> FileDiffMarks {
