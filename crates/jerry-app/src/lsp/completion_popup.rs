...
impl AdeApp {
    ...
    pub(crate) fn render_completions_popover(
        ...
        let mut selected_item: Option<&jerry_lsp::lsp_types::CompletionItem> = None;
...
fn render_completion_row(
    index: usize,
    item: &jerry_lsp::lsp_types::CompletionItem,
    is_selected: bool,
...
mod completions_scroll_tests {
    ...
    fn fake_items(count: usize) -> Vec<jerry_lsp::lsp_types::CompletionItem> {
        (0..count)
            .map(|index| jerry_lsp::lsp_types::CompletionItem {
...
mod completion_detail_pane_tests {
    ...
    fn a_real_jsdoc_tag_in_the_completion_doc_body_paints_its_own_tag_run(cx: &mut TestAppContext) {
        let item = jerry_lsp::lsp_types::CompletionItem {
            label: "push_str".to_string(),
            detail: Some("fn push_str(&mut self, string: &str)".to_string()),
            documentation: Some(jerry_lsp::lsp_types::Documentation::String(
    ...
    fn a_real_selected_item_paints_both_the_list_column_and_a_real_detail_pane(
        ...
        let item = jerry_lsp::lsp_types::CompletionItem {
            ...
            label_details: Some(jerry_lsp::lsp_types::CompletionItemLabelDetails {
                detail: None,
    ...
    fn a_short_lists_flipped_above_position_is_close_to_the_caret_not_the_worst_case_height(
        ...
        let short_status = CompletionsStatus::ready(
            vec![jerry_lsp::lsp_types::CompletionItem {
    ...
    fn accepting_a_real_auto_import_writes_its_import_line_and_keeps_the_caret(
        ...
        let item = jerry_lsp::lsp_types::CompletionItem {
            ...
            kind: Some(jerry_lsp::lsp_types::CompletionItemKind::FUNCTION),
            detail: Some("fs".to_string()),
            additional_text_edits: Some(vec![jerry_lsp::lsp_types::TextEdit {
                range: jerry_lsp::lsp_types::Range {
                    start: jerry_lsp::lsp_types::Position::new(1, 0),
                    end: jerry_lsp::lsp_types::Position::new(1, 0),
                },
    ...
    fn repeated_auto_import_candidates_paint_one_row_naming_its_module(cx: &mut TestAppContext) {
        let candidate = |module: &str| jerry_lsp::lsp_types::CompletionItem {
            label: "appendFile".to_string(),
            kind: Some(jerry_lsp::lsp_types::CompletionItemKind::FUNCTION),
    ...
    fn a_landed_resolve_fills_the_detail_pane_and_leaves_the_row_alone(cx: &mut TestAppContext) {
        let bare = jerry_lsp::lsp_types::CompletionItem {
            label: "app".to_string(),
            kind: Some(jerry_lsp::lsp_types::CompletionItemKind::VARIABLE),
            ..Default::default()
        };
        ...
        app.update(cx, |app, cx| {
            app.apply_resolved_completion_item(
                ...
                generation,
                0,
                Ok(jerry_lsp::lsp_types::CompletionItem {
    ...
    fn an_ordinary_item_with_no_import_paints_no_import_source(cx: &mut TestAppContext) {
        let item = jerry_lsp::lsp_types::CompletionItem {
            ...
            kind: Some(jerry_lsp::lsp_types::CompletionItemKind::FIELD),
    ...
    fn a_very_long_documentation_string_does_not_grow_the_pane_without_bound(
        ...
        let long_doc_item = jerry_lsp::lsp_types::CompletionItem {
            label: "long_doc".to_string(),
            documentation: Some(jerry_lsp::lsp_types::Documentation::String(long_doc)),
            ..Default::default()
        };
