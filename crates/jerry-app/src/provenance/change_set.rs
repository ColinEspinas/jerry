...
use jerry_git::diff::{DiffFile, DiffLineKind, FileChangeStatus, WorktreeDiff};
...
pub struct ChangeSetEntry {
    ...
    /// path (matching `jerry_git::diff::DiffFile::path`).
    pub path: PathBuf,
...
mod tests {
    ...
    use jerry_git::diff::{diff_against_base, DiffHunk, DiffLine};
