...
impl LspConnection {
    ...
    pub(super) fn request<R: lsp_core::lsp_types::request::Request>(
        &self,
        params: R::Params,
        timeout: Duration,
    ...
    pub(super) fn has_diagnostics_result_uri(&self, uri: &lsp_core::lsp_types::Uri) -> bool {
    ...
    pub(super) fn liveness_failure_reason(&self) -> Option<String> {
    ...
    pub(super) fn supports_document_sync(&self) -> bool {
        self.primary().supports_document_sync()
    }

    /// See [`Self::supports_document_sync`] on why this reads the primary only.
    pub(super) fn supports_diagnostic_pull(&self) -> bool {
        self.primary().supports_diagnostic_pull()
    }

    /// See [`Self::supports_document_sync`] on why this reads the primary only.
    pub(super) fn completion_trigger_characters(&self) -> Vec<String> {
    ...
    pub(super) fn companion_diagnostics_pull_target(
        &self,
...
impl AdeApp {
    ...
    pub(super) fn lsp_connection_for_path(
        &self,
        path: &Path,
...
/// `crate::root::code_surface`'s own `vue_two_server_wiring_tests` (it lives there because it
