...
//! `crate::edit_buffer::EditBuffer`'s pure logic. Three real pieces live here:
//!
...
//!    `crate::root::code_surface::AdeApp::render_code_surface`'s own docs for exactly where that
...
use crate::{code_view, hover_view, theme};

/// How long after the last keystroke [`AdeApp::schedule_rehighlight`] waits before running a real
/// `tree-sitter` re-highlight - see `crate::edit_buffer`'s own "Re-highlighting cost" docs for the
...
impl AdeApp {
    ...
    /// `REHIGHLIGHT_DEBOUNCE` docs and `crate::edit_buffer`'s "Re-highlighting cost" docs for why.
    ...
    pub(super) fn handle_editor_backspace_action(
        &mut self,
        _: &EditorBackspace,
        _window: &mut Window,
        cx: &mut Context<Self>,
    ...
    pub(super) fn handle_editor_delete_action(
        &mut self,
        _: &EditorDelete,
        _window: &mut Window,
        cx: &mut Context<Self>,
    ...
    pub(super) fn handle_editor_enter_action(
        &mut self,
        _: &EditorEnter,
        window: &mut Window,
        cx: &mut Context<Self>,
    ...
    pub(super) fn handle_editor_left_action(
        &mut self,
        _: &EditorLeft,
        _window: &mut Window,
        cx: &mut Context<Self>,
    ...
    pub(super) fn handle_editor_right_action(
        &mut self,
        _: &EditorRight,
        _window: &mut Window,
        cx: &mut Context<Self>,
    ...
    pub(super) fn handle_editor_up_action(
        &mut self,
        _: &EditorUp,
        _window: &mut Window,
        cx: &mut Context<Self>,
    ...
    pub(super) fn handle_editor_down_action(
        &mut self,
        _: &EditorDown,
        _window: &mut Window,
        cx: &mut Context<Self>,
    ...
    pub(super) fn handle_editor_select_left_action(
        &mut self,
        _: &EditorSelectLeft,
        _window: &mut Window,
        cx: &mut Context<Self>,
    ...
    pub(super) fn handle_editor_select_right_action(
        &mut self,
        _: &EditorSelectRight,
        _window: &mut Window,
        cx: &mut Context<Self>,
    ...
    pub(super) fn handle_editor_select_up_action(
        &mut self,
        _: &EditorSelectUp,
        _window: &mut Window,
        cx: &mut Context<Self>,
    ...
    pub(super) fn handle_editor_select_down_action(
        &mut self,
        _: &EditorSelectDown,
        _window: &mut Window,
        cx: &mut Context<Self>,
    ...
    pub(super) fn handle_editor_home_action(
        &mut self,
        _: &EditorHome,
        _window: &mut Window,
        cx: &mut Context<Self>,
    ...
    pub(super) fn handle_editor_end_action(
        &mut self,
        _: &EditorEnd,
        _window: &mut Window,
        cx: &mut Context<Self>,
    ...
    pub(super) fn handle_editor_select_all_action(
        &mut self,
        _: &EditorSelectAll,
        _window: &mut Window,
        cx: &mut Context<Self>,
    ...
    pub(super) fn handle_editor_copy_action(
        &mut self,
        _: &EditorCopy,
        _window: &mut Window,
        cx: &mut Context<Self>,
    ...
    pub(super) fn handle_editor_cut_action(
        &mut self,
        _: &EditorCut,
        window: &mut Window,
        cx: &mut Context<Self>,
    ...
    pub(super) fn handle_editor_paste_action(
        &mut self,
        _: &EditorPaste,
        window: &mut Window,
        cx: &mut Context<Self>,
    ...
    /// `std::fs::metadata` stat call (mirroring `crate::root::code_surface::AdeApp::
    ...
    ///
    /// Still real-guarded by [`crate::edit_buffer::EditBuffer::is_dirty`], though (finding 7's own
    ...
    pub(super) fn force_save_active_file(&mut self, cx: &mut Context<Self>) {
        let Some(path) = self.active_editable_path() else {
            return;
        };
        let Some(buffer) = self.edit_buffers.get(&path) else {
...
/// (`crate::root::code_surface::AdeApp::render_file_view`) hands to
/// [`render_editable_file_view_line`] - see that function's own docs.
pub(super) struct EditableLineContext<'a> {
...
/// docs). Structurally mirrors `crate::root::code_surface::render_file_view_line`'s gutter/git-
...
/// ambient font/size.
pub(super) fn render_editable_file_view_line(
...
/// `crate::root::code_surface::render_file_view_line` (the read-only path) already uses, so the
...
/// click boundaries (`crate::root::code_surface::render_file_view_line`), computed here from a
...
mod editing_tests {
    ...
    /// (`crates/app/src/root/code_surface.rs`) for making sure the background load has actually
