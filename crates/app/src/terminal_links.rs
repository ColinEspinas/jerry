...
//! scanner over plain `&str` - `crate::terminal_pane::render_row` is the one real call site,
    ...
    regex
        ...
        .filter_map(|caps| {
            ...
            let line = caps
                ...
                // `crate::root::code_surface::AdeApp::navigate_to_definition`'s own
...
/// `crate::root::code_surface::AdeApp::open_terminal_link`'s own `path.is_file()` existence
