...
//! time on a platform where it doesn't exist. `crate::root::status_bar` matches this by omitting
...
/// poll (see `crate::terminal_pane`'s `MAX_EOF_POLL_TICKS`) is a real zombie for up to ~10s, and
