//! `jerry-lsp`: a Language Server Protocol client, spawning and driving `rust-analyzer`.
//!
//! Its own crate rather than a module of `jerry-app`, for the same reason as `jerry-pty`: no GPUI
